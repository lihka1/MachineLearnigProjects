...
print "test accuracy is :",\
    p1.average_passive_aggressive_accuracy(train_bow_features,test_bow_features,
                                           train_labels, test_labels, best_T, best_L)
#-------------------------------------------------------------------------------
#
#-------------------------------------------------------------------------------
# Section 2.11b
...
#-------------------------------------------------------------------------------
best_theta = p1.average_passive_aggressive(train_bow_features, train_labels, 
                                           best_T, best_L)[0]
